...
export const metadata: Metadata = generateMetadata(seoConfigs.browse);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-text-muted max-w-3xl mx-auto">
              Explore our extensive database of verified Hindu profiles. Find
              your perfect life partner from educated, professionally
              established individuals across various communities.
            </p>
          </div>
        </div>
      </section>
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-text-muted">
                      Age: {25 + i} • {["Delhi", "Mumbai", "Bangalore"][i - 1]}
                    </p>
                  </div>
                </div>
                <div className="space-y-2 text-sm text-text">
                  <p>
                    ...
                    {["MBA", "M.Tech", "MBBS", "CA", "PhD", "B.Tech"][i - 1]}
                  </p>
                  <p>
      ...
      <section className="bg-primary py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/90 mb-8">
            Join thousands of Hindu families who have found their life partners
