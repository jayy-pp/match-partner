...
const footerLinks = {
  Product: [
    ...
    { label: "Aadhaar Verification", href: "/verification" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16">
          ...
          <div className="mb-12">
            ...
            <img
              src="/images/logo.png"
              alt="MatchPartner"
              className="h-18 w-auto p-2 bg-white rounded-xl"
            />
            <p className="text-white/70 mt-2 text-sm font-medium">
              Trusted Hindu Matrimony Platform
            </p>
            <p className="text-white/50 mt-3 max-w-md text-sm leading-relaxed">
              Connecting families and hearts through tradition, trust, and
              technology. Find your perfect life partner with AI-powered
              matchmaking and verified profiles.
            </p>
          </div>
        ...
        <div className="border-t border-white/10 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <a
                href="mailto:hello@matchpartner.in"
                className="text-white/70 hover:text-white text-sm transition"
              >
                hello@matchpartner.in
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/50 text-sm">
            &copy; 2026 MatchPartner. All rights reserved.
          </p>
